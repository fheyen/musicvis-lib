...
var require_d3_brush = __commonJS({
  "node_modules/.pnpm/d3-brush@2.1.0/node_modules/d3-brush/dist/d3-brush.js"(exports2, module3) {
    (function(global2, factory) {
      ...
      function empty(extent6) {
        return extent6[0][0] === extent6[1][0] || extent6[0][1] === extent6[1][1];
      }
      ...
      function brush$1(dim) {
        var extent6 = defaultExtent, filter = defaultFilter, touchable = defaultTouchable, keys = true, listeners = d3Dispatch.dispatch("start", "brush", "end"), handleSize = 6, touchending;
        function brush2(group8) {
          ...
          overlay.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", cursors.overlay).merge(overlay).each(function() {
            var extent7 = local(this).extent;
            d3Selection.select(this).attr("x", extent7[0][0]).attr("y", extent7[0][1]).attr("width", extent7[1][0] - extent7[0][0]).attr("height", extent7[1][1] - extent7[0][1]);
          });
        ...
        function started(event) {
          ...
          if (!filter.apply(this, arguments))
            return;
          var that = this, type3 = event.target.__data__.type, mode = (keys && event.metaKey ? type3 = "overlay" : type3) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type3], signY = dim === X ? null : signsY[type3], state = local(that), extent7 = state.extent, selection = state.selection, W = extent7[0][0], w0, w1, N = extent7[0][1], n0, n1, E = extent7[1][0], e0, e1, S = extent7[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
        ...
        function initialize() {
          ...
          state.extent = number2(extent6.apply(this, arguments));
          state.dim = dim;
          return state;
        }
        brush2.extent = function(_) {
          return arguments.length ? (extent6 = typeof _ === "function" ? _ : constant(number2(_)), brush2) : extent6;
        };
...
var require_d3_force = __commonJS({
  "node_modules/.pnpm/d3-force@2.1.1/node_modules/d3-force/dist/d3-force.js"(exports2, module3) {
    (function(global2, factory) {
      ...
      function link(links) {
        var id = index, strength = defaultStrength, strengths, distance = constant(30), distances, nodes, count2, bias, random, iterations = 1;
        if (links == null)
          links = [];
...
var require_d3_geo = __commonJS({
  "node_modules/.pnpm/d3-geo@2.0.2/node_modules/d3-geo/dist/d3-geo.js"(exports2, module3) {
    (function(global2, factory) {
      ...
      function fitExtent(projection2, extent7, object2) {
        return fit(projection2, function(b) {
          var w = extent7[1][0] - extent7[0][0], h = extent7[1][1] - extent7[0][1], k = Math.min(w / (b[1][0] - b[0][0]), h / (b[1][1] - b[0][1])), x = +extent7[0][0] + (w - k * (b[1][0] + b[0][0])) / 2, y = +extent7[0][1] + (h - k * (b[1][1] + b[0][1])) / 2;
      ...
      function projectionMutator(projectAt) {
        ...
        projection2.fitExtent = function(extent7, object2) {
          return fitExtent(projection2, extent7, object2);
        };
      ...
      function albersUsa() {
        ...
        albersUsa2.fitExtent = function(extent7, object2) {
          return fitExtent(albersUsa2, extent7, object2);
        };
      ...
      exports3.geoClipExtent = extent6;
      ...
      function ticker(year2, month2, week, day2, hour2, minute2) {
        ...
        function tickInterval(start, stop, count2) {
          ...
          if (i === tickIntervals.length)
            return year2.every(d3Array.tickStep(start / durationYear, stop / durationYear, count2));
          if (i === 0)
            return millisecond.every(Math.max(d3Array.tickStep(start, stop, count2), 1));
  ...
  "node_modules/.pnpm/d3-scale@3.3.0/node_modules/d3-scale/dist/d3-scale.js"(exports2, module3) {
    (function(global2, factory) {
      ...
      function tickFormat(start, stop, count2, specifier) {
        var step = d3Array.tickStep(start, stop, count2), precision;
      ...
      function linearish(scale) {
        ...
        scale.ticks = function(count2) {
          var d = domain();
          return d3Array.ticks(d[0], d[d.length - 1], count2 == null ? 10 : count2);
        };
        ...
        scale.nice = function(count2) {
          ...
          while (maxIter-- > 0) {
            step = d3Array.tickIncrement(start, stop, count2);
            if (step === prestep) {
              d[i0] = start;
              d[i1] = stop;
              return domain(d);
      ...
      function zoom() {
        ...
        zoom2.scaleTo = function(selection, k, p, event) {
          zoom2.transform(selection, function() {
            var e = extent6.apply(this, arguments), t0 = this.__zoom, p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t0.invert(p0), k1 = typeof k === "function" ? k.apply(this, arguments) : k;
            return constrain(translate(scale(t0, k1), p0, p1), e, translateExtent);
          }, p, event);
        };
        zoom2.translateBy = function(selection, x, y, event) {
          zoom2.transform(selection, function() {
            return constrain(this.__zoom.translate(typeof x === "function" ? x.apply(this, arguments) : x, typeof y === "function" ? y.apply(this, arguments) : y), extent6.apply(this, arguments), translateExtent);
          }, null, event);
        };
        zoom2.translateTo = function(selection, x, y, p, event) {
          zoom2.transform(selection, function() {
            var e = extent6.apply(this, arguments), t = this.__zoom, p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p;
        ...
        function schedule(transition, transform2, point, event) {
          transition.on("start.zoom", function() {
            ...
            var that = this, args = arguments, g = gesture(that, args).event(event), e = extent6.apply(that, args), p = point == null ? centroid(e) : typeof point === "function" ? point.apply(that, args) : point, w = Math.max(e[1][0] - e[0][0], e[1][1] - e[0][1]), a = that.__zoom, b = typeof transform2 === "function" ? transform2.apply(that, args) : transform2, i = interpolate(a.invert(p).concat(w / a.k), b.invert(p).concat(w / b.k));
            return function(t) {
              if (t === 1)
                t = b;
              else {
        ...
        function dblclicked(event, ...args) {
          if (!filter.apply(this, arguments))
            return;
          var t0 = this.__zoom, p0 = d3Selection.pointer(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t0.invert(p0), k1 = t0.k * (event.shiftKey ? 0.5 : 2), t1 = constrain(translate(scale(t0, k1), p0, p1), extent6.apply(this, args), translateExtent);
          noevent(event);
          if (duration > 0)
        ...
        zoom2.extent = function(_) {
          return arguments.length ? (extent6 = typeof _ === "function" ? _ : constant([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom2) : extent6;
        };
...
function normalizeNdArrayNegative(array) {
  const extent6 = d32.extent(array.flat(Number.POSITIVE_INFINITY));
  const scale = d32.scaleLinear().domain(extent6);
  const normalize = (array_) => array_.map((d) => {
    return d.length !== void 0 ? normalize(d) : scale(d);
  });
...
var Track = class {
  constructor(name2, instrument, notes, tuningPitches = null, measureIndices = null, measureRehearsalMap, noteLyricsMap, xmlNoteIndices = null) {
    ...
    this.notes = notes.sort(Note_default.startPitchComparator);
  ...
  getSectionInfo() {
    const sections = [];
    for (const [startMeasure, name2] of this.measureRehearsalMap.entries()) {
      sections.push({ name: name2, startMeasure, endMeasure: null });
    }
  ...
  getSections(sectionInfo, measures, sortComparator) {
    ...
    for (let index = 1; index < indices.length + 1; ++index) {
      const notes = measures.slice(indices[index - 1], indices[index]).flat();
      if (sortComparator) {
        notes.sort(sortComparator);
      }
...
__export(Canvas_exports, {
  ...
  drawBezierFunnelY: () => drawBezierFunnelY,
...
function drawBezierFunnelY(context, y1, y2, x1left, x1right, x2left, x2right) {
  const deltaY = (y2 - y1) / 2;
  context.beginPath();
  context.moveTo(x1left, y1);
  context.bezierCurveTo(x1left, y1 + deltaY, x2left, y1 + deltaY, x2left, y2);
  context.lineTo(x2right, y2);
  context.bezierCurveTo(x2right, y1 + deltaY, x1right, y1 + deltaY, x1right, y1);
  context.closePath();
  context.fill();
}
...
function generateExampleData(startTime = 0, count2 = 50, tuning) {
