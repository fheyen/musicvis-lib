...
describe('MusicUtils', () => {
  ...
  describe('MetronomeTrack', () => {
    ...
    describe('from music piece', () => {
      ...
      const mp4over3meter = MusicPiece.fromMidi('test', readMidiFile('[Test] 3-4 meter.mid'))
      test('3-4 meter.mid', () => {
        expect(
          metronomeTrackFromMusicPiece(mp4over3meter)
        ).toStrictEqual([
          {
            accent: true,
            time: 0,
      ...
      test('tempo factor', () => {
        expect(
          metronomeTrackFromMusicPiece(mp4over3meter, 0.5)
        ).toStrictEqual([
          {
            accent: true,
            time: 0,
